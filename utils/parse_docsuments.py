...
#     parser=parser()
#     content = parser.extract_text(doc_path="G:/scripts/PG-AGI/hiring-assistant-chatbot/submissions/resumes/VAIBHAV_SINGH_f4f686b7-ebab-4df0-bebc-b9a350f37c9d_resume.pdf")
#     print("\n📄 Extracted Content:\n")
